...
// Kontrola, zda bylo předáno ID dílny a zda je to číslo
...
try {
    // Nejprve získáme název dílny pro zprávu (volitelné, ale užitečné)
    ...
    // Díky ON DELETE CASCADE v definici tabulky `prihlasky` se automaticky smažou
