                ...
                <div class="dilna-karta">
                    <div class="dilna-obsah">
                        <div class="dilna-header">
                            ...
                            <span class="kategorie-tag">
                                <?php
                                if (stripos($dilna['nazev_dilna'], 'cookie') !== false || stripos($dilna['nazev_dilna'], 'zdobení') !== false || stripos($dilna['nazev_dilna'], 'pečení') !== false ) {
                                    echo "Pečení";
                                } elseif (stripos($dilna['nazev_dilna'], 'keramik') !== false || stripos($dilna['nazev_dilna'], 'tvoření') !== false || stripos($dilna['nazev_dilna'], 'malování') !== false || stripos($dilna['nazev_dilna'], 'výroba') !== false) {
                                    echo "Tvoření";
                                } else {
                                    echo "Dílna";
                                }
