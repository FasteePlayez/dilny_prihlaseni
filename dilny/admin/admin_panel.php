...
// --- ZDE ZAČÍNÁ SPECIFICKÝ OBSAH PRO admin_panel.php ---
            ...
            <tbody>
                <?php foreach($existujici_dilny as $ex_dilna): ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- Odkazy pro akce jsou relativní k aktuálnímu adresáři /admin/ -->
                            ...
                            <a href="smaz_dilnu.php?id_dilna=<?php echo $ex_dilna['id_dilna']; ?>"
                               ...
                               style="color: red;">Smazat</a> <!-- Tento inline styl by bylo lepší přesunout do CSS -->
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
...
<?php
// --- ZDE KONČÍ SPECIFICKÝ OBSAH PRO admin_panel.php ---
