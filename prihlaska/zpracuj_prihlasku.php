...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Najít nebo vytvořit dítě pro daného rodiče
        ...
        // Zkontrolovat, zda dítě již není přihlášeno na více než 3 dílny
        ...
        // Zkontrolovat, zda dítě již není přihlášeno na tuto konkrétní dílnu
        ...
        $_SESSION['message_type'] = "error";
        error_log("PDO Error: " . $e->getMessage()); // Logování chyby pro admina
        header("Location: prihlaska.php?id_dilna=" . $id_dilna);
        exit;
    } catch (Exception $e) {
